...
public class UnbinderTest {
  ...
  @Test public void unbindingThroughAbstractChild() {
    ...
    JavaFileObject expectedSource2 = JavaFileObjects.forSourceString("test/TestTwo$$ViewBinder",
        ...
        + "    return (U) new InnerUnbinder(target);\n"
        + "  }\n"
        + "  public static class InnerUnbinder<T extends TestTwo> extends Test$$ViewBinder.InnerUnbinder<T> {\n"
        + "    View view1;\n"
        + "    protected InnerUnbinder(T target) {\n"
        + "      super(target);\n"
        + "    }\n"
  ...
  @Test public void fullIntegration() {
    ...
    JavaFileObject expectedSourceC = JavaFileObjects.forSourceString("test/C$$ViewBinder",
        ...
        + "    return (U) new InnerUnbinder(target);\n"
        + "  }\n"
        + "  public static class InnerUnbinder<T extends C> implements Unbinder {\n"
        + "    private T target;\n"
        + "    protected InnerUnbinder(T target) {\n"
        + "      this.target = target;\n"
        + "    }\n"
    ...
    JavaFileObject expectedSourceG = JavaFileObjects.forSourceString("test/G$$ViewBinder",
        ...
        + "  @SuppressWarnings(\"unchecked\")\n"
        + "  @Override\n"
        + "  protected <U extends C$$ViewBinder.InnerUnbinder<T>> U createUnbinder(T target) {\n"
        + "    return (U) new InnerUnbinder(target);\n"
        + "  }\n"
        + "  public static class InnerUnbinder<T extends G> extends C$$ViewBinder.InnerUnbinder<T> {\n"
        + "    View view16908290;\n"
        + "    protected InnerUnbinder(T target) {\n"
        + "      super(target);\n"
        + "    }\n"
    ...
    JavaFileObject expectedSourceH = JavaFileObjects.forSourceString("test/H$$ViewBinder",
        ...
        + "    return (U) new InnerUnbinder(target);\n"
        + "  }\n"
        + "  public static class InnerUnbinder<T extends H> extends G$$ViewBinder.InnerUnbinder<T> {\n"
        + "    protected InnerUnbinder(T target) {\n"
        + "      super(target);\n"
        + "    }\n"
        + "    @Override\n"
