 ...
 * <pre><code>
 * {@literal @}BindColors({R.color.background_green, R.color.background_blue})
 * List&lt;Integer&gt; colors;
 * {@literal @}BindColors({R.color.background_green_selector, R.color.background_blue_selector})
