  ...
  @Test public void superclass() {
    ...
    JavaFileObject expectedSource2 = JavaFileObjects.forSourceString("test/TestOne$$ViewInjector",
        Joiner.on('\n').join(
            ...
            "import android.view.View;",
            "import butterknife.ButterKnife.Finder;",
            "public class TestOne$$ViewInjector extends test.Test$$ViewInjector {",
            "  public void inject(Finder finder, final test.TestOne target, Object source) {",
            "    super.inject(finder, target, source);",
            "    View view;",
            "    view = finder.findRequiredView(source, 1, \"field 'thing'\");",
            "    target.thing = view;",
            "  }",
            "  public void reset(test.TestOne target) {",
            "    super.reset(target);",
            "    target.thing = null;",
            "  }",
            "}"
